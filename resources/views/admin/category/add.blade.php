                ...
                <form role="form" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="form-group" style="overflow: auto;">
                            <label for="content">内容</label> @if ($errors->has('content')) {{ $errors->first('description') }} @endif
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="sort" class="form-control" id="sort" value="{{ old('sort') }}" placeholder="" autocomplete="off" required>
                        </div>
                    </div>
                    <!-- /.box-body -->
