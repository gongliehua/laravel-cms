                ...
                <form role="form" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="uri" class="form-control" id="uri" value="{{ old('uri') }}" placeholder="" autocomplete="off">
                        </div>
                        <div class="form-group">
                            <label for="icon">图标</label> @if ($errors->has('icon')) {{ $errors->first('icon') }} @endif
                            <input type="text" name="icon" class="form-control" id="icon" value="{{ old('icon') }}" placeholder="">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="sort" class="form-control" id="sort" value="{{ old('sort') ? old('sort') : '0' }}" placeholder="" required>
                        </div>
                        <div class="form-group">
