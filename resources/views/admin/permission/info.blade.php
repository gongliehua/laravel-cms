                ...
                <form role="form" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" id="title" value="{{ $permission->title }}" placeholder="" autocomplete="off">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="sort" class="form-control" id="sort" value="{{ $permission->sort }}" placeholder="">
                        </div>
                        <div class="form-group">
                            <label>上级权限</label>
