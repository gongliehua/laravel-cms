        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <a href="{{ url('admin/permissionAdd') }}" class="btn btn-sm btn-success" title="新增"><i class="fa fa-plus"></i><span class="hidden-xs"> 新增</span></a>
                </div>
                <!-- /.box-header -->
                        ...
                        @if (count($permissions) > 0)
                            ...
                            @foreach ($permissions as $key=>$value)
                                <tr>
                                    ...
                                    <td>{{ $value->uri }}</td>
                                    <td>{{ $value->icon }}</td>
                                    <td>@if ($value->is_menu == 1) 是 @else 否 @endif</td>
                                    ...
                                    <td>
                                        <a href="{{ url('admin/permissionInfo') }}?id={{ $value->id }}"><i class="fa fa-eye"></i></a>
                                        <a href="{{ url('admin/permissionEdit') }}?id={{ $value->id }}"><i class="fa fa-edit"></i></a>
                                        <a href="javascript:void(0)" onclick="warning('确定要删除?','{{ url('admin/permissionDel') }}?id={{ $value->id }}')" class="grid-row-delete"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                                <tr>
