                        ...
                        <div class="form-group" id="rules">
                            ...
                            @if (count($rules) > 0)
                                @foreach ($rules as $key=>$value)
                                    <div class="checkbox"><label><input type="checkbox" name="rules[]" value="{{ $value->id }}" data-id="{{ $value->id }}" data-parentid="{{ $value->parent_id }}">@if ($value->parent_id === 0) ｜ @endif {{ str_repeat('－',$value->level*4) }} {{ $value->title }}</label></div>
                                @endforeach
                            @else
