                        ...
                        @if (count($configs) > 0)
                            ...
                            @foreach ($configs as $key=>$value)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('admin/infoConfig') }}?id={{ $value->id }}"><i class="fa fa-eye"></i></a>
                                        <a href="{{ url('admin/editConfig') }}?id={{ $value->id }}"><i class="fa fa-edit"></i></a>
                                        <a href="javascript:void(0)" onclick="warning('确定要删除?','{{ url('admin/delConfig') }}?id={{ $value->id }}')" class="grid-row-delete"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                                <tr>
