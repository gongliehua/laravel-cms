                ...
                <form role="form" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" id="title" value="{{ $config->title }}" placeholder="" autocomplete="off" required>
                        </div>
                        <div class="form-group">
                            <label for="name">名称</label> @if ($errors->has('name')) {{ $errors->first('name') }} @endif
                            <input type="text" name="name" class="form-control" id="name" value="{{ $config->name }}" placeholder="" autocomplete="off" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="value" id="value" rows="3" placeholder="">{{ $config->value }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="values">可选值</label> @if ($errors->has('values')) {{ $errors->first('values') }} @endif
                            <textarea class="form-control" name="values" id="values" rows="3" placeholder="">{{ $config->values }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="sort">排序</label> @if ($errors->has('sort')) {{ $errors->first('sort') }} @endif
                            <input type="text" name="sort" class="form-control" id="sort" value="{{ $config->sort }}" placeholder="" autocomplete="off" required>
                        </div>
                    </div>
                    <!-- /.box-body -->
